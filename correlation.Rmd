...
hulu <- readLipd("~/Dropbox/Hulucave.Wang.2001-ens.lpd")
gisp2 <- readLipd("~/Dropbox/GISP2.Alley.2000-ens.lpd")
...
We'll run it with only 200 ensemble members for now, since we have multiple significance testing options turned on and it can be a little slow.
...
```{r,warning=FALSE,message=FALSE,fig.width=6, fig.height=4,echo=FALSE,eval=TRUE}
